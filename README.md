...
Mi Band 10용 Lua 엔진 워치페이스의 초기 소스입니다. 검은 배경 위에 흰색 BCD 점만 가로로 배치해 현재 시각을 표현합니다.
...
```text
app/lua/main.lua        # LVGL 점 객체와 dataman 시간 구독
...
4. `src/preview.html`과 실제 밴드에서 시간·방향·점 간격을 확인합니다.
